...
class botnews_command(commands.Cog):
    ...
    async def botnews(self, ctx):
        ...
        embed.add_field(name="Google", value="Now you can use `,google <what you want to search>` or `/google` to google some things\nIt's against the rules to google things like p*rn<:hahaha6:740166145167982623>")
        embed.add_field(name="Bug fixes", value="We fixed some bugs again, and made sure, that this release is mostly \"bug free\".", inline=False)
